...
public class AudioHandler {
	...
	public final static float FOOTSTEPS_VOLUME  = 0.1f;
	public static final float QUICK_SAND_VOLUME = 0.5f;
	...
	public final static float AMBIENT_MUSIC_VOLUME    = 0.25f;
	public final static float INVINCIBLE_MUSIC_VOLUME = 0.25f;

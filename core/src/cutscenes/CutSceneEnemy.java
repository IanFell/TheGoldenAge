 ...
 *
 */
public class CutSceneEnemy extends CutScene {
	 ...
	 * @param String name
	 */
	public CutSceneEnemy(String name) {
		super(name);
		startXPosition          = 0; 
		startYPosition          = 0; 
	...
	public void renderCutScene(MyGame myGame) {
		if (!cutSceneConcluded) {
			renderBackgroundImage(myGame.renderer.batch, myGame, myGame.imageLoader.cutsceneBackGroundImageEnemy);
